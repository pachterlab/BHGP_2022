...
# Stub functions for gggroupedscale (visual grouping decorations omitted)
...
plot_assemble(annotate_text("(A)", x = 2, y =1, vjust = 1, fontsize = font_size, fontface = "bold"),
              ...
              annotate_graphic("../illustrations/benchmark_overviewArtboard_1.pdf", x = 32,  y = 109, units = "mm"),
              annotate_graphic("../illustrations/benchmark_overviewArtboard_3.pdf", x = 92,  y = 109, units = "mm"),
              annotate_graphic("../illustrations/benchmark_overviewArtboard_2.pdf", x = 152, y = 109, units = "mm"),
