...
simulation_pl <- res_main %>%
  ...
  # Same widening rationale as the downsampling panel: PFlog (shift. CLR) lands
...
downsampling_pl <- res_main %>%
  ...
  make_main_plot_panel(add_group_label = FALSE) +
  # PFlog (shift. CLR) is ~5x more depth-robust than every other method, so its
...
(originally the last sub-panel of AE&H Fig 2 panel d). PFlog (shift. CLR)
