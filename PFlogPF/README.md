...
- `notebooks/fig3_angelidis_pseudobulk/` contains the Figure 3 Angelidis2019 pseudobulk PCA, edgePython differential-expression, and PC1-loading comparison script and source data.
- `notebooks/fig4_panel_sensitivity/` contains the Figure 4 Smart-seq3 feature-panel sensitivity source data and scatter-panel plotting script.
...
- `output/smartseq3_fibroblasts_paired_procrustes_displacement_projection.pdf` and `output/smartseq3_fibroblasts_paired_distance_scatter.pdf` are the Figure 4 panels used in the manuscript.
